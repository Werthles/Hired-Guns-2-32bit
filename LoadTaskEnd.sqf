...
private ["_theGroup", "_missionFileName", "_newTask", "_NPC", "_missionNumber", "_groupArray", "_missionObjectList", "_title", "_spawn2", "_spawn3", "_spawn4", "_allDone", "_check1", "_aiLeader", "_check", "_Mission0", "_Mission1", "_Mission2", "_Mission3", "_Mission4", "_Mission5", "_Mission6", "_taskState"];
