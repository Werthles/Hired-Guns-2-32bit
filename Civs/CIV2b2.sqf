...
_this addWeaponGlobal "SMG_02_F";
_this addPrimaryWeaponItem "optic_Holosight_smg_blk_F";
_this addWeaponGlobal "launch_B_Titan_short_tna_F";
...
_this addMagazine ["30Rnd_9x21_Mag_SMG_02_Tracer_Red",30];
_this addMagazine ["30Rnd_9x21_Mag_SMG_02_Tracer_Red",30];
_this addMagazine ["30Rnd_9x21_Mag_SMG_02_Tracer_Red",30];
_this addMagazine ["30Rnd_9x21_Mag_SMG_02_Tracer_Red",30];
_this addMagazine ["MiniGrenade",1];
_this addMagazine ["Titan_AT",1];
_this addMagazine ["Titan_AT",1];
_this addMagazine ["Titan_AT",1];