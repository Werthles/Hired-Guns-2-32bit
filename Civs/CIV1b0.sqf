...
_this addWeaponGlobal "hgun_Pistol_01_F";
_this addWeaponGlobal "Binocular";
_this addWeaponGlobal "srifle_DMR_05_hex_F";
...
_this addMagazine ["10Rnd_9x21_Mag",10];
_this addMagazine ["10Rnd_9x21_Mag",10];
_this addMagazine ["10Rnd_9x21_Mag",10];
_this addMagazine ["10Rnd_9x21_Mag",10];
_this addMagazine ["MiniGrenade",1];
_this addMagazine ["Chemlight_blue",1];
_this addMagazine ["10Rnd_93x64_DMR_05_Mag",10];
_this addMagazine ["10Rnd_93x64_DMR_05_Mag",10];
_this addMagazine ["10Rnd_93x64_DMR_05_Mag",10];
_this addMagazine ["10Rnd_93x64_DMR_05_Mag",10];
_this addMagazine ["10Rnd_93x64_DMR_05_Mag",10];
