...
_this addWeaponGlobal "SMG_01_F";
_this addPrimaryWeaponItem "optic_Holosight_blk_F";
_this addWeaponGlobal "launch_NLAW_F";
...
_this addMagazine ["Chemlight_blue",1];
_this addMagazine ["SmokeShellRed",1];
_this addMagazine ["SmokeShell",1];
_this addMagazine ["30Rnd_45ACP_Mag_SMG_01",30];
_this addMagazine ["30Rnd_45ACP_Mag_SMG_01",30];
_this addMagazine ["30Rnd_45ACP_Mag_SMG_01",30];
_this addMagazine ["30Rnd_45ACP_Mag_SMG_01",30];
_this addMagazine ["30Rnd_45ACP_Mag_SMG_01",30];
